      ...
      <div className="flex flex-col gap-y-16 w-full px-[415px] pt-[84px]">
          <div className="flex flex-col gap-y-10">
              ...
              <div className="flex flex-col gap-y-10">
                  ...
                  <div>
                      ...
                      <ul className="list-disc list-inside font-inter font-normal text-lg leading-[170%] text-left text-swamp-blue pl-3">
          ...
          <div className="flex flex-col gap-y-10">
              ...
              <div className="flex flex-col">
                  ...
                  <p className="font-inter font-normal text-lg leading-[170%] text-left text-swamp-blue pt-8">
                      Ние обработваме вашата пратка като всяка друга голяма товарна пратка – старателно и професионално.
                  </p>
              </div>
          </div>
